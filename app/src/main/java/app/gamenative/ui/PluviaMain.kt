...
import app.gamenative.managers.TranslationOverlayButton
import app.gamenative.ui.component.DragonBackground
import app.gamenative.ui.screen.admin.AdminPanelScreen
import app.gamenative.ui.screen.marketplace.MercadoLivreScreen
...
fun PluviaMain(
    ...
    // Gamekt Pro: Dragon background touch tracking
    var dragonTouchX by remember { mutableFloatStateOf(-1f) }
    var dragonTouchY by remember { mutableFloatStateOf(-1f) }

    // Gamekt Pro: Admin panel visibility
    var showAdminPanel by rememberSaveable { mutableStateOf(false) }
    ...
    PluviaTheme(
        ...
        Box(
            modifier = Modifier
                ...
                .pointerInput(Unit) {
                    detectTapGestures { offset ->
                        dragonTouchX = offset.x
                        dragonTouchY = offset.y
                    }
                },
        ) {
            DragonBackground(
            ...
            if (showAdminPanel) {
                AdminPanelScreen(
                    onNavigateToMarketplace = {
                        ...
                        navController.navigate(PluviaScreen.MercadoLivre.route)
                    },
            ...
            NavHost(
                ...
                /** Gamekt Pro: Loja Mercado Livre **/
                composable(route = PluviaScreen.MercadoLivre.route) {
                    MercadoLivreScreen(
